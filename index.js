...
$(function() {
    ...
    function checkCoordsValid(x, y) {
        return snake.filter(function(e) {
            return e.x === x && e.y === y;
        }).length < 1;
    }
    ...
    function moveSnake(direction) {
        ...
        switch (direction) {
            ...
            case 'TOP': {
                ...
                else if(!checkCoordsValid(snake[snake.length-1].x, snake[snake.length-1].y - snakeSize)){
                    gameOver();
                    break;
                }
                else{
            ...
            case 'RIGHT': {
                ...
                //checks if snake is on the current location
                else if(!checkCoordsValid(snake[snake.length-1].x + snakeSize, snake[snake.length-1].y)){
                    gameOver();
                    break;
                }
                else{
